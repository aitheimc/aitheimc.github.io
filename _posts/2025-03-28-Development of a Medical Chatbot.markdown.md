...
LLM 기반 의료정보 조회 챗봇을 개발하며 얻은 다양한 경험과 노하우를 공유하고자 합니다. 성능 최적화, 신뢰성 확보, 개인화 및 문맥 관리, 평가 및 피드백 등 여러 측면에서 접근했으며, 특히 '프롬프트 엔지니어링', '개인화 데이터 연동', '테스트 데이터 구성'에 초점을 맞추어 실제 개발 과정에서 경험한 내용을 중심으로 설명하겠습니다.
<!--more-->
- **성능 최적화**
